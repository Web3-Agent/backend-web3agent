export const chainlinkCCIPRouterABI = [
    {
      "type": "constructor",
      "inputs": [
        {
      ...
      "inputs": [
        ...
        },
        {
          ...
          "components": [
            ...
            { "name": "offRamp", "type": "address", "internalType": "address" }
          ]
        },
        {
          "name": "offRampAdds",
    ...
    },
    {
      ...
      "outputs": [
        ...
        { "name": "retData", "type": "bytes", "internalType": "bytes" },
    ...
    { "type": "error", "name": "FailedToSendValue", "inputs": [] },
    ...
    { "type": "error", "name": "OnlyOffRamp", "inputs": [] },
    {
      "type": "error",
